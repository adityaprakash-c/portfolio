...
3. Customize the content (name, stats, projects, etc.) in the HTML files.
4. Replace placeholder icons with your own profile photo if desired.

## Technologies
- HTML5, CSS3 (Flexbox/Grid), JavaScript (ES6)
- Font Awesome 6, Google Fonts (Orbitron, JetBrains Mono)

## Deployment
This portfolio is static and can be hosted on GitHub Pages, Netlify, Vercel, or any web server.
